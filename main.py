...
def generate_doctor_prompt(input_values: dict, risk_probs: dict, medications: List[Medication], 
    ...
    prompt_parts = [
        ...
        f'    "doctor_recommendations": [',
        f'        "Key clinical findings and prioritized risk factors for this {specialty}",',
        f'        "Medication adjustments: [list specific changes with dosages, timing, and duration]for this {specialty}",',
        f'        "New medication suggestions: [include name, dosage, frequency, duration, and rationale]for this {specialty}",',
        f'        "Lab tests: [list with frequency and clinical rationale]for this {specialty}",',
        f'        "Monitoring plan: [specific parameters and follow-up schedule]for this {specialty}",',
        f'        "Critical questions to ask patient: [based on their profile]for this {specialty}",',
        f'        "Red flags requiring immediate attention for this {specialty}",',
        f'        "Medication interaction warnings and management for this {specialty}"',
        '    ],',
        '    "medication_analysis": [',
        '        {',
